...
let AddChannelComponent = class AddChannelComponent {
    ...
    ngOnInit() {
        this.userData.channelsSubject.subscribe((channels) => this.channels = channels);
    }
    subscribe(index) {
...
let BalanceComponent = class BalanceComponent {
    ...
    ngOnInit() {
        this.userData.accountBalanceSubject.subscribe((balance) => {
...
let RechargeComponent = class RechargeComponent {
    constructor(userData, formBuilder, toastyService) {
        this.userData = userData;
...
RechargeComponent.ctorParameters = () => [
...
let SubscribeBaseComponent = class SubscribeBaseComponent {
    constructor(userData) {
        this.userData = userData;
        this.baseServicePack = [];
    }
    ngOnInit() {
        this.userData.baseServicePackSubject.subscribe((baseServicePack) => this.baseServicePack = baseServicePack);
    }
    subscribe(index) {
...
SubscribeBaseComponent.ctorParameters = () => [
    { type: _services_user_data_service__WEBPACK_IMPORTED_MODULE_2__["UserDataService"] }
];
...
let SubscribeSpecialComponent = class SubscribeSpecialComponent {
    constructor(userData) {
        this.userData = userData;
        this.specialService = [];
    }
    ngOnInit() {
        this.userData.specialServicePackSubject.subscribe((specialService) => this.specialService = specialService);
    }
    subscribe(index) {
...
SubscribeSpecialComponent.ctorParameters = () => [
    { type: _services_user_data_service__WEBPACK_IMPORTED_MODULE_2__["UserDataService"] }
];
...
let SubscribtionDetailComponent = class SubscribtionDetailComponent {
    constructor(userData) {
        this.userData = userData;
    }
    ngOnInit() {
        this.userData.baseServicePackSubject.subscribe((baseServicePack) => {
            this.baseServicePack = [];
            this.baseServicePack = baseServicePack;
            this.baseServicePack = this.baseServicePack.filter(x => x.subscribed === true);
        });
        this.userData.specialServicePackSubject.subscribe((specialServicePack) => {
            this.specialServicePack = [];
            this.specialServicePack = specialServicePack;
            this.specialServicePack = this.specialServicePack.filter(x => x.subscribed === true);
        });
        this.userData.channelsSubject.subscribe((channels) => {
            this.channels = [];
...
SubscribtionDetailComponent.ctorParameters = () => [
    { type: _services_user_data_service__WEBPACK_IMPORTED_MODULE_2__["UserDataService"] }
];
...
let ToastyComponent = class ToastyComponent {
    ...
    ngOnInit() {
        this.toastyService.toastySubject.subscribe((toasty) => {
            this._toasty = toasty;
        });
    }
    closeToasty() {
...
let UserDetailUpdateComponent = class UserDetailUpdateComponent {
    constructor(userData, formBuilder, toastyService) {
        this.userData = userData;
        this.formBuilder = formBuilder;
        this.toastyService = toastyService;
    ...
    ngOnInit() {
        ...
        this.userData.userDataSubject.subscribe((user) => {
...
UserDetailUpdateComponent.ctorParameters = () => [
    { type: _services_user_data_service__WEBPACK_IMPORTED_MODULE_2__["UserDataService"] },
...
let ViewChannelsComponent = class ViewChannelsComponent {
    constructor(userData) {
        this.userData = userData;
        this.baseServicePack = [];
        this.specialServicePack = [];
    ...
    ngOnInit() {
        this.userData.baseServicePackSubject.subscribe((baseServicePack) => this.baseServicePack = baseServicePack);
        this.userData.specialServicePackSubject.subscribe((specialServicePack) => this.specialServicePack = specialServicePack);
        this.userData.channelsSubject.subscribe((channels) => this.channels = channels);
    }
};
ViewChannelsComponent.ctorParameters = () => [
    { type: _services_user_data_service__WEBPACK_IMPORTED_MODULE_2__["UserDataService"] }
];
